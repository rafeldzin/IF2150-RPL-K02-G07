...
| *C02* | *Produk* | *Menyimpan data produk berupa nama, harga jual, margin, dan tag yang dikelola oleh pemilik usaha (Entity Class).* | *UC03, UC04, UC05* |
| *C03* | *BahanBaku* | *Menyimpan data harga beli bahan baku yang digunakan sebagai resep produk (Entity Class).* | *UC03, UC04, UC09, UC10* |
...
| *C08* | *ResetPasswordPage* | *Antarmuka untuk menerima input berupa password baru yang dibuat oleh user dan merupakan password yang berbeda dengan password lama (Boundary Class).* | *UC10* |
...
| *C10* | *AddProductPage* | *Antarmuka untuk menerima input data produk dan menampilkan hasil kalkulasi secara real time (Boundary Class).* | *UC04* |
| *C11* | *MarginController* | *Menghitung perbedaan harga jual dan harga standar untuk menghasilkan margin yang untung/rugi (Controller Class).* | *UC04* |
...
| *C14* | *RiwayatHargaBahanBaku* | *Menyimpan data entitas catatan fluktuasi harga beli bahan baku beserta waktu perubahannya (Entity Class).* | *UC09* |
| *C15* | *TrenBahanBakuPage* | *Antarmuka yang menampilkan daftar bahan baku, rentang waktu, dan memvisualisasikan grafik tren (Boundary Class).* | *UC09* |
| *C16* | *TrendController* | *Mengambil data riwayat harga dari database, menerapkan filter waktu, dan mengonversinya menjadi format grafik (Controller Class).* | *UC09* |
| *C17* | *Notifikasi* | *Menyimpan detail pesan peringatan kerugian, waktu dikirim, dan status keterbacaan (Entity Class).* | *UC10* |
| *C18* | *PushNotificationUI* | *Antarmuka notifikasi sistem operasi (OS) yang muncul di perangkat pengguna (Boundary Class).* | *UC10* |
| *C18* | *NotificationController* | *Mendeteksi hasil margin negatif setelah pembaruan harga, membuat objek notifikasi, dan memicu pengiriman pesan (Controller Class).* | *UC10* |
...
| *C02* | *RegistrationPage* | *Antarmuka untuk menerima input data Username, Email dan Password pemilik usaha serta tombol "Buat Akun" untuk mendaftarkan akun pemilik usaha ke dalam database milik perangkat lunak (Boundary Class).* |
| *C03* | *AuthController* | *Memastikan bahwa input yang dilakukan oleh pemilik usaha sudah sesuai dengan data milik perangkat lunak (Controller).* |
...
| :--- | :--- | :--- |
| *C01* | *PemilikUsaha* | *Menyimpan data entitas akun pemilik usaha yang sedang membuat produk baru (Entity Class).* |
| *C02* | *LoginPage* | *Antarmuka untuk menerima input data Username/Email dan Password pemilik usaha serta tombol "Login" (Boundary Class).* |
| *C03* | *AuthController* | *Memastikan bahwa input yang dilakukan oleh pemilik usaha sudah sesuai dengan data milik perangkat lunak (Controller).* |
...
| *C03* | *Produk* | *Menyimpan data entitas produk, meliputi nama, tag, harga jual, dan margin, yang menjadi target pencarian (Entity Class).* |
| *C07* | *SearchProductPage* | *Antarmuka untuk menerima input kata kunci/tag pencarian dari pengguna dan menampilkan daftar produk hasil pencarian (Boundary Class).* |
| *C08* | *ProductSearchController* | *Memproses kata kunci/tag yang diinput dan melakukan pencocokan (filtering) terhadap data produk untuk menghasilkan daftar produk yang relevan (Controller Class).* |
...
| :--- | :--- | :--- | :--- |
| *C01* | *PemilikUsaha* | *username, password* | *getUsername(), getPassword()* |
| *C03* | *Produk* | *namaProduk, tag, hargaJual, margin* | *getNamaProduk(), getTag(), getHargaJual(), getMargin()* |
| *C07* | *SearchProductPage* | *kataKunciPencarian, hasilPencarian* | *showPage(), showResults(), showErrorMessage()* |
| *C08* | *ProductSearchController* | *currentPemilik, kataKunci* | *searchProduk(), filterByTag()* |
...
| *C03* | *Produk* | *Menyimpan data entitas produk yang harga jualnya ingin ditelusuri riwayat perubahannya (Entity Class).* |
| *C09* | *RiwayatHarga* | *Menyimpan data entitas catatan perubahan harga jual suatu produk beserta waktu perubahannya (Entity Class).* |
| *C10* | *PriceHistoryPage* | *Antarmuka untuk menampilkan data/grafik historis perubahan harga jual suatu produk (Boundary Class).* |
| *C11* | *PriceHistoryController* | *Mengambil data riwayat harga dari database dan menyusunnya menjadi format yang dapat ditampilkan (Controller Class).* |
...
| :--- | :--- | :--- | :--- |
| *C01* | *PemilikUsaha* | *username, password* | *getUsername(), getPassword()* |
| *C03* | *Produk* | *namaProduk, hargaJualSaatIni* | *getNamaProduk(), getHargaJualSaatIni()* |
| *C09* | *RiwayatHarga* | *hargaLama, hargaBaru, waktuPerubahan* | *getHargaLama(), getHargaBaru(), getWaktuPerubahan()* |
| *C10* | *PriceHistoryPage* | *produkTerpilih, rentangWaktuFilter* | *showPage(), showChart(), showErrorMessage()* |
| *C11* | *PriceHistoryController* | *currentPemilik, currentProduk* | *getRiwayatHarga(), filterDataByDate(), generateChartData()* |
...
| *C07* | *RiwayatHargaBahanBaku* | *Menyimpan data entitas catatan fluktuasi harga beli bahan baku beserta waktu perubahannya (Entity Class).* |
| *C10* | *TrenBahanBakuPage* | *Antarmuka yang menampilkan daftar bahan baku, rentang waktu, dan memvisualisasikan grafik tren (Boundary Class).* |
| *C11* | *TrendController* | *Mengambil data riwayat harga dari database, menerapkan filter waktu, dan mengonversinya menjadi format grafik (Controller Class).* |
...
| *C01* | *PemilikUsaha* | *username, password* | *getUsername(), getPassword()* |
| *C03* | *BahanBaku* | *namaBahan, hargaBeli* | *getNamaBahan(), getHargaBeli()* |
| *C07* | *RiwayatHargaBahanBaku* | *hargaBeliLama, waktuPerubahan* | *getHargaBeliLama(), getWaktuPerubahan()* |
| *C10* | *TrenBahanBakuPage* | *bahanBakuTerpilih, rentangWaktuFilter* | *showPage(), showChart(), showErrorMessage()* |
| *C11* | *TrendController* | *currentPemilik, currentBahanBaku* | *getRiwayatHarga(), filterDataByDate(), generateChartData()* |
...
| *C08* | *Notifikasi* | *Menyimpan detail pesan peringatan kerugian, waktu dikirim, dan status keterbacaan (Entity Class).* |
| *C12* | *PushNotificationUI* | *Antarmuka notifikasi sistem operasi (OS) yang muncul di perangkat pengguna (Boundary Class).* |
| *C13* | *NotificationController* | *Mendeteksi hasil margin negatif setelah pembaruan harga, membuat objek notifikasi, dan memicu pengiriman pesan (Controller Class).* |
...
| *C08* | *Notifikasi* | *idNotifikasi, pesanAlert, waktuKirim, isRead* | *getPesanAlert(), markAsRead()* |
| *C12* | *PushNotificationUI* | *notifikasiAktif* | *tampilkanNotifikasi(), onClickNotification()* |
| *C13* | *NotificationController* | *currentPemilik, targetProduk* | *cekMarginNegatif(), buatNotifikasiKerugian(), kirimNotifikasi()* |
