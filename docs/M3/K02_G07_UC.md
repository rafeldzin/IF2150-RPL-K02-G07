...
**Skenario Alternatif 2: Pencarian Rentang Waktu Tidak Memiliki Data**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pemilik Usaha memilih suatu produk spesifik dari daftar produk.* | *Sistem menampilkan halaman detail dari produk yang dipilih.* |
| 2 | *Pemilik Usaha menekan tombol atau tab "Riwayat Harga".* | *Sistem menampilkan seluruh daftar perubahan harga produk.* |
| 3 | *Pemilik Usaha menerapkan filter rentang waktu (misalnya: "1 Minggu Terakhir").* | *Sistem mendeteksi bahwa tidak ada data pada rentang waktu tersebut dan menampilkan pesan "Tidak ada data perubahan harga pada rentang waktu yang dipilih".* |
...
**Skenario Alternatif 2: Kenaikan Harga Berdampak pada Banyak Produk Sekaligus**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pemilik Usaha memperbarui harga beli bahan baku utama yang memicu kerugian pada lebih dari satu menu produk bersamaan.* | *Sistem menyimpan harga baru, melakukan kalkulasi, dan mendeteksi adanya beberapa produk yang marginnya menjadi negatif.* |
| 2 | *Pemilik Usaha menutup aplikasi atau berpindah halaman.* | *Sistem mengelompokkan peringatan dan mengirimkan satu push notification rangkuman (misal: "3 Menu Produk merugi").* |
| 3 | *Pemilik Usaha menekan push notification tersebut.* | *Sistem membuka aplikasi dan mengarahkan pengguna ke halaman Daftar Produk dengan menerapkan filter khusus secara otomatis untuk menampilkan produk yang merugi saja.* |
